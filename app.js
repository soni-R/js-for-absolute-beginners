...
for(var x = 0; x <= names.length-1; x=x+1){ // or in place of (x <= names.length-1) we can use x < names.length, since x means index, that is one less than number of elements in array.
	console.log(names[x]);
}
